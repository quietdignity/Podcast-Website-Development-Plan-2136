        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/listen" className="text-cream-200 hover:text-cream-50 transition-colors">
                  Listen
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-cream-200 hover:text-cream-50 transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link to="/education" className="text-cream-200 hover:text-cream-50 transition-colors">
                  Education
                </Link>
              </li>
              <li>
                <Link to="/speaking" className="text-cream-200 hover:text-cream-50 transition-colors">
                  Speaking
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-cream-200 hover:text-cream-50 transition-colors">
                  Contact
                </Link>
              </li>
              <li>
                <Link to="/voicemail" className="text-cream-200 hover:text-cream-50 transition-colors">
                  Leave Voice Message
                </Link>
              </li>
            </ul>
