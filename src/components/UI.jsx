...
<a href="https://open.spotify.com/show/5Impg5m0ZPEuE9ezKFcP5A" target="_blank" rel="noopener noreferrer" className="text-cream-200 hover:text-cream-50 transition-colors">Spotify</a>
</li>
<li className="flex items-center space-x-2">
<SafeIcon icon={FiMusic} className="w-4 h-4" />
<a href="https://podcasts.apple.com/us/podcast/the-daily-note-with-james-a-brown/id1679222021" target="_blank" rel="noopener noreferrer" className="text-cream-200 hover:text-cream-50 transition-colors">Apple Podcasts</a>
</li>
<li className="flex items-center space-x-2">
<SafeIcon icon={FiRss} className="w-4 h-4" />
<a href="https://feeds.captivate.fm/jamesbrowninterviews/" target="_blank" rel="noopener noreferrer" className="text-cream-200 hover:text-cream-50 transition-colors">RSS Feed</a>
</li>
</ul>
</div>
...
const [userSession]=useState(()=> sessionStorage.getItem('userSession') || Math.random().toString(36).substring(2,15))
