      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <blockquote className="text-lg text-gray-700 italic">
            "This isn't theory. These are the strategies I've used and seen work from inside government 
            communications. You'll learn what officials actually respond to, not what you think they should respond to."
          </blockquote>
        </motion.div>
