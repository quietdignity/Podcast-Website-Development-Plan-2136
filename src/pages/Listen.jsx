...
const Listen=()=> {
const platforms=[
{name: 'Spotify',url: 'https://open.spotify.com/show/5Impg5m0ZPEuE9ezKFcP5A',icon: '🎵'},
{name: 'Apple Podcasts',url: 'https://podcasts.apple.com/us/podcast/the-daily-note-with-james-a-brown/id1679222021',icon: '🎵'},
{name: 'RSS Feed',url: 'https://feeds.captivate.fm/jamesbrowninterviews/',icon: '📡'}
]
